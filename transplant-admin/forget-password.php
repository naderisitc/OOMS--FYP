...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT UserName FROM tableadmin WHERE Email=:email";
    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $result) {
            ...
            $mail->addAddress($email, 'Transplant Admin');     // Add a recipient
            ...
            $generatedPassword1 = (rand(999, 999999));
            $generatedPassword = $generatedPassword1;

            $mail->Subject = 'Reset Password - Transplant Centre Admin';
            $mail->Body = "Dear $username,<br><br>Recently a request was submitted to reset the password for your account."
            ...
            $sql1 = "UPDATE tableadmin SET PassWord=:generatedPassword WHERE Email=:email";
...
<html lang="en">
    <head>
        ...
        <title>Forget Password | Transplant Admin Log In</title>
                            ...
                            <div class="well row pb-2x pb-2x ">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <form method="post" style="margin-top: 25px;">
                                        ...
                                        <a href="tindex.php" class="btn btn-danger"><font face="Trebuchet MS" style="font-size:14px;"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<b>Back</b></font></a>
