...
if (strlen($_SESSION['tlogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        $id = $_GET['del'];
        $sql = "delete from tableheart WHERE id=:id";
        $query = $dbh->prepare($sql);
        $query->bindParam(':id', $id, PDO::PARAM_STR);
        $query->execute();
        $msg = " Patient deleted successfully from the OOMS Heart waiting list.";
    }
}
?>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin | Patient Heart List  </title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="page-title"><font face="Comic Sans MS" color="red"> Heart Waiting List - Patients</font></h2>

                            <!-- Zero Configuration Table -->
                            <div class="panel panel-default">
                                <div class="panel-heading" style="color: green;">Personal and Medical Information - Heart Patients </div>
                                <div class="panel-body">
                                    <?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) {
                                        ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                                    <a href="heart-download-records.php" style="color:red; font-size:16px;"><span class="glyphicon glyphicon-save-file"></span> &nbsp;Download Heart Waiting List</a>
                                    <div class="scroll">
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    ...
                                                    foreach ($results as $result) {
                                                        ...
                                                        <tr> <!-- Display Records -->
                                                            ...
                                                            <td><?php echo ("<a target='_blank' href='view-heart-image.php?id=" . $result->id . "'>" . $result->name . "</a>"); ?></td>
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php } ?></td>
                                                            <td><a href="update-heart-info.php?id=<?php echo htmlentities($result->id); ?>"><button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></button></a> &nbsp;
                                                                <a href="heart-list.php?del=<?php echo $result->id; ?>"><button class="btn btn-danger btn-xs" onClick="return confirm('Do you really want to delete the patient from the Heart waiting list?');"><span class="glyphicon glyphicon-trash"></span></button></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $cnt = $cnt + 1;
