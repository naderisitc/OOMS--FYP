...
if (strlen($_SESSION['tlogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        if (!empty($_POST['organ1']) || !empty($_POST['organ2']) || !empty($_POST['organ3']) || !empty($_POST['organ4']) || !empty($_POST['organ5'])) {
            // Query for Updation          
            $sql = "UPDATE tableorgandonors SET FullName=:fullname,Passport=:passport,Nationality=:nationality, "
                    . "MobileNumber=:mobile,Email=:email,State=:state,Gender=:gender,DateOfBirth=:dob,BloodType=:bloodtype,"
                    . "Address=:address,OrganDonated=:organ1,OrganDonated2=:organ2,OrganDonated3=:organ3,OrganDonated4=:organ4,"
                    . "OrganDonated5=:organ5 WHERE Donor_id=:uid ";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h2 class="page-title"><font face="Comic Sans MS" color="red">Update Donor Information</font></h2>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post"  class="form-horizontal" >
                                                    ...
                                                    // Get the userid
                                                    $userid = intval($_GET['Donor_id']);
                                                    $sql = "SELECT FullName,Passport,Nationality,MobileNumber,Email,State,Gender,DateOfBirth,BloodType,Address,OrganDonated,OrganDonated2,OrganDonated3,OrganDonated4,OrganDonated5,name,mime,data,Donor_id from tableorgandonors where Donor_id=:uid";
                                                    //Prepare the query:
                                                    $query = $dbh->prepare($sql);
                                                    //Bind the parameters
                                                    $query->bindParam(':uid', $userid, PDO::PARAM_STR);
