...
if (strlen($_SESSION['tlogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        // Query for Updation
        $sql = "UPDATE tablepancreas SET FullName=:fullname,Passport=:passport,Nationality=:nationality, MobileNumber=:mobile,Email=:email,DateOfBirth=:dob,OrganNeeded=:organ,MedicalUrgency=:medical,State=:state,Gender=:gender,BloodType=:bloodtype,Address=:address WHERE id=:uid ";
        ...
        echo "<script>window.location.href='pancreas-list.php'</script>";
    }
    ?>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h2 class="page-title"><font face="Comic Sans MS" color="red">Update Patient Information - Pancreas</font></h2>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post" class="form-horizontal">
                                                    ...
                                                    // Get the userid
                                                    $userid = intval($_GET['id']);
                                                    $sql = "SELECT FullName,Passport,Nationality,MobileNumber,Email,DateOfBirth,OrganNeeded,MedicalUrgency,State,Gender,BloodType,Address,id from tablepancreas where id=:uid";
                                                    //Prepare the query:
                                                    $query = $dbh->prepare($sql);
                                                    //Bind the parameters
                                                    $query->bindParam(':uid', $userid, PDO::PARAM_STR);
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-6 col-sm-offset-4">
                                                            <a class="btn btn-md btn-default" href="pancreas-list.php" role="button"><font face="Trebuchet MS" style="font-size:14px;"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<b>Back</b></font></a>
