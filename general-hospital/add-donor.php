...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $ret = "SELECT HospitalName FROM tablegeneralhospital where PassWord=:password"; // check Hospital Password
        $queryt = $dbh->prepare($ret);
        $queryt->bindParam(':password', $password, PDO::PARAM_STR);
        $queryt->execute();
        $results = $queryt->fetchAll(PDO::FETCH_OBJ);
        if ($queryt->rowCount() > 0) {
            foreach ($results as $resultp) {

                $username = $resultp->HospitalName;
                ...
                if (in_array($ext, $valid_extensions)) {
                    if ($imageSize > 1000 && $imageSize <= 1000000) { // image size checker, less than 1 MB
    ...
    <html lang="en">
        ...
        <head>
            ...
            <title>General Hospital | Add Donor</title>
                                            ...
                                            <div class="panel-body">
                                                <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" name="fullname" placeholder="Donor name can contain letters only" title="Donor name can contain letters only" class="form-control" pattern="[a-zA-Z\s]+" maxLength="25" required>
                                                        </div>
                                                        <!-- ========== IC/Passport No. ========== -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" name="mobileno" pattern="[0-9]{14}" maxlength="14" title="Remove any characters/spaces/negative numbers. Enter 14 numbers only, e.g. 00601113328804" placeholder="Enter only 14 numeric values." class="form-control"  required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 col-sm-offset-2">
                                                            <a class="btn btn-md btn-default" href="dashboard.php" role="button"><font face="Trebuchet MS" style="font-size:14px;"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<b>Back</b></font></a>
